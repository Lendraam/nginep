  ...
  return (
    <main className="min-h-screen bg-purple-50 flex items-center justify-center">
      <section className="w-full max-w-md bg-white p-6 rounded shadow">
        <h1 className="text-xl font-bold text-purple-700 mb-4 text-center">Profil Admin</h1>
        <div className="flex flex-col items-center mb-4">
          {preview ? (
            <img src={preview} alt="Foto Profil" className="w-20 h-20 rounded-full object-cover mb-2" />
          ) : (
            <div className="w-20 h-20 rounded-full bg-purple-100 flex items-center justify-center text-3xl text-purple-400 mb-2">?</div>
          )}
